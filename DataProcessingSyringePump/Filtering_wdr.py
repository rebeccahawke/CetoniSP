...
filename = '20191002_step_25sccm_w_25.0_1569978536_alldata.csv'
...
# f_g = 1.21 # input('Estimated frequency: ')
...
f_g = 1.16 # input('Estimated frequency: ')
...
V_fit = sinusoid(t,A_fit,f_fit,phi_fit)
plt.plot(t,V)
...
# phi3 = -2.33181
#
# V_fit1 = sinusoid(time[:p2], A2, f2, phi2)
